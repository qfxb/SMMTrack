...
if __name__ == '__main__':
    ...
    parser.add_argument('--script_name', type=str, default='smmtrack_track', help='Name of tracking method(ostrack, prompt, ftuning).')
    parser.add_argument('--yaml_name', type=str, default='vitb_256_smmtrack_e', help='Name of tracking method.')
    ...
    if dataset_name == 'VisEvent':
        seq_home = '/home/w/QFXB/TT/E_data/test'
