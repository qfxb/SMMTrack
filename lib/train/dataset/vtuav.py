...
class VTUAV(BaseVideoDataset):
    ...
    def _get_frame_path(self, seq_path, frame_id):
        vis_frame_names = sorted(os.listdir(os.path.join(seq_path, 'rgb')))
        inf_frame_names = sorted(os.listdir(os.path.join(seq_path, 'ir')))

        return os.path.join(seq_path, 'rgb', vis_frame_names[frame_id]), os.path.join(seq_path, 'ir', inf_frame_names[frame_id])
