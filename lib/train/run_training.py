...
def main():
    ...
    parser.add_argument('--script', type=str, default='smmtrack_track', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='vitb_256_smmtrack_t', help="Name of the config file.")
