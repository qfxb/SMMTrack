...
class DepthTrackDataset(BaseDataset):
    """ LasHeR dataset for RGB-D tracking.
    ...
    def __init__(self, split):
        ...
        if split == 'testingset' or split == 'test':
            self.base_path = os.path.join(self.env_settings.depthtrack_path, split)
        else:
            self.base_path = os.path.join(self.env_settings.depthtrack_path, 'train')
    ...
    def _construct_sequence(self, sequence_name):
        ...
        frames_path_i = '{}/{}/depth'.format(self.base_path, sequence_name)
        frames_path_v = '{}/{}/color'.format(self.base_path, sequence_name)
