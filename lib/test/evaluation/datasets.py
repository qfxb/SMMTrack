...
dataset_dict = dict(
    ...
    draw2=DatasetInfo(module=pt % "lasher", class_name="draw2Dataset", kwargs=dict(split='testingset')),
    depthtrack_test=DatasetInfo(module=pt % "depthtrack", class_name="DepthTrackDataset", kwargs=dict(split='test')),
    visevent_test=DatasetInfo(module=pt % "visevent", class_name="VisEventDataset", kwargs=dict(split='test')),
