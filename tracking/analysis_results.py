...
parser.add_argument('--tracker_name', default='smmtrack_track')
parser.add_argument('--tracker_param', default='vitb_256_smmtrack_t', type=str, help='Name of config file.')
